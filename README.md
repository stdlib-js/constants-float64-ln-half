...
```javascript
import LN_HALF from 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float64-ln-half@v0.2.3-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/constants-float64-ln-half/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/constants-float64-ln-half/actions/workflows/test.yml?query=branch:v0.2.3
